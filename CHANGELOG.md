...
- resources/views/back/pages/auth    [`forgot.blade.php`](./resources/views/back/pages/auth/forgot.blade.php)   [`login.blade.php`](./resources/views/back/pages/auth/forgot.blade.php)
...
- resources/views/back/layouts/inc    [`header.blade.php`](./routes/header.blade.php)   [`footer.blade.php`](./routes/header.blade.php)

> 4 : Laravel Livewire - Login process

- resources/views/back/layouts    [`auth-layout.blade.php`](./resources/views/back/layouts/auth-layout.blade.php)   [`pages-layout.blade.php`](./auth-layout.blade.php/pages-layout.blade.php)
- resources/views/livewire    [`author-login-form.blade.php`](./resources/views/livewire/author-login-form.blade.php)
- app/Models           [`Type.php`](./app/Models/Type.php)    [`User.php`](./app/Models/User.php)
- database/migrations   [`2024_06_17_093115_create_types_table.php`](./database/migrations/2024_06_17_093115_create_types_table.php)
- routes    [`web.php`](./routes/web.php)   [`author.php`](./web.php/author.php)
- app/Providers      [`RouteServicesProvider.php`](./app/Providers/RouteServicesProvider.php)
- app/Http/Middleware    [`Authenticate.php`](./app/Http/Middleware/Authenticate.php)    [`RedirectIfAuthenticated.php`](./Authenticate.php/RedirectIfAuthenticated.php)
...
- app/Livewire   [`AuthorForgotForm.php`](./app/Livewire/AuthorForgotForm.php)    [`AuthorResetForm.php`](./app/Livewire/AuthorResetForm.php)
- resources/views/livewire    [`author-forgot-form.blade.php`](./resources/views/livewire/author-forgot-form.blade.php)  [`author-reset-form.blade.php`](./resources/views/livewire/author-reset-form.blade.php)  [`author-login-form.blade.php`](./resources/views/livewire/author-login-form.blade.php)
- resources/views     [`forgot-email-template.blade.php`](./resources/views/forgot-email-template.blade.php)
- resources/views/back/pages     [`forgot.blade.php`](./resources/views/back/pages/forgot.blade.php)
...
- public/back/dist/libs/jquery    [`jquery-3.6.0.min.js`](./public/back/dist/libs/jquery/jquery-3.6.0.min.js)
- public/back/dist/libs/ijabo     [`ijabo.min.js`](./public/back/dist/libs/ijabo/ijabo.min.js)    [`ijabo.min.css`](./public/back/dist/libs/ijabo/ijabo.min.css)
- resources/views/back/layouts    [`pages-layout.blade.php`](./resources/views/back/layouts/pages-layout.blade.php)
- app/Livewire   [`AuthorPersonalDetails.php`](./app/Livewire/AuthorPersonalDetails.php)
- public/traits  [`CommonFunctions.php`](./public/traits/CommonFunctions.php)
...
- app/Livewire   [`AuthorChangePasswordForm.php`](./app/Livewire/AuthorChangePasswordForm.php)
...
- public/back/dist/image/authors    [`default-img.png`](./public/back/dist/image/authors/default-img.png) [`AIMG1171896834756899.jpg`](./public/back/dist/image/authors/AIMG1171896834756899.jpg)
- app/Modelss   [`User.php`](./app/Modelss/User.php)
- resources/views/livewire    [`author-profile-header.blade.php`](./resources/views/livewire/author-profile-header.blade.php)   [`top-header.blade.php`](./resources/views/livewire/top-header.blade.php)
- public/back/dist/image/libs/ijaboCropTools    [`ijaboCropTool.min.css`](./public/back/dist/image/libs/ijaboCropTools/ijaboCropTool.min.css)    [`ijaboCropTool.min.js`](./public/back/dist/image/libs/ijaboCropTools/ijaboCropTool.min.js)
- resources/views/back/layouts    [`pages-layout.blade.php`](./resources/views/back/layouts/pages-layout.blade.php)
- routes    [`author.php`](./routes/author.php)
- resources/views/back/pages    [`profile.blade.php`](./resources/views/back/pages/profile.blade.php)
- app/Http/Controllers    [`AuthorController.php`](./app/Http/Controllers/AuthorController.php)
...
- routes    [`author.php`](./routes/author.php)
- resources/views/livewire    [`top-header.blade.php`](./resources/views/livewire/top-header.blade.php)     [`author-general-settings.blade.php`](./resources/views/livewire/author-general-settings.blade.php)    [`author-footer.blade.php`](./resources/views/livewire/author-footer.blade.php)
...
- database/migrations          [`yyyy_mm_dd_hhmmss_create_settings_table.php`](./database/migrations/yyyy_mm_dd_hhmmss_create_settings_table.php)
- app/Livewire   [`AuthorGeneralSettings.php`](./app/Livewire/AuthorGeneralSettings.php)    [`AuthorFooter.php`](./app/Livewire/AuthorFooter.php)
- resources/views/back/layouts/inc    [`footer.blade.php`](./resources/views/back/layouts/inc/footer.blade.php)
...
- resources/views/back/pages/auth    [`login.blade.php`](./resources/views/back/pages/auth/login.blade.php)    [`reset.blade.php`](./resources/views/back/pages/auth/reset.blade.php)    [`forgot.blade.php`](./resources/views/back/pages/auth/forgot.blade.php)
